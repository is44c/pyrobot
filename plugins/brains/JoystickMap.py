...
class Map(Brain):
   def setup(self):
       ...
       rangeMaxMM = self.robot.get('range', 'maxvalue')
       sizeMM = rangeMaxMM * 3 + self.getRobot().get('self', 'radius')
       ...
       self.gps = GPS(share.gui, maxrange=rangeMaxMM, cols=500, rows=500,
